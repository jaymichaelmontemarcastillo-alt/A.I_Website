...
/**
 * api/admin_site/get_quotation_for_audit.php
 * Fetches a single quotation with its items for audit pre-filling
 */
...
try {
    ...
    $stmt = $pdo->prepare("
        SELECT 
            ...
            total, notes, status, created_at, audited
        FROM quotations 
        WHERE id = :id
    ");
    ...
    error_log("get_quotation_for_audit.php error: " . $e->getMessage());
    echo json_encode([
        'success' => false,
